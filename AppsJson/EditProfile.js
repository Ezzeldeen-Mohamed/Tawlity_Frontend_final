document.addEventListener("DOMContentLoaded", function () {
    ...
    async function loadUserProfile() {
        try {
            const response = await fetch(`https://tawlity.runasp.net/api/UserProfile/${userId}`);
    ...
    form.addEventListener("submit", async function (event) {
        ...
        try {
            const response = await fetch(`https://tawlity.runasp.net/api/User/UpdateUser/${userId}`, {
                method: "PUT",
                headers: {
